const images = [
    ...
    "../QuizImages/Formsignale.jpg",
    "../QuizImages/Kabel.jpg",
    "../QuizImages/Doppelweichungskreuzung.jpg",
    ...
    "../QuizImages/Ks-Mehrabschnittssignal.jpg",
    "../QuizImages/Triebfahrzeugführer_IC-Steuerwagen.jpg",
    "../QuizImages/Elektromechanisches_Motorzählwerk_für_Achszähler_von_Siemens.jpg",
    "../QuizImages/Elektronisches_Stellwerk_Köln-Betriebsbahnhof-3887.jpg",
    "../QuizImages/Einfahrt_der_Dreiseenbahn_in_den_Bahnhof_Titisee.jpg",
    "../QuizImages/Schienenkontakt_Siemens_DMK.jpg",
    "../QuizImages/Technik_Relaisstellwerk_Köln_Kf-4038.jpg",
    "../QuizImages/Ks_Ks2+Zusatzlicht_(oben).svg",
    "../QuizImages/WuS_Logo_L.jpg",
    "../QuizImages/Achszähler.jpg",
    "../QuizImages/Ks_Ks2+Zusatzlicht_(unten).svg"
];
...
const questions = [
    ...
    },
    {
        ...
        image: "../QuizImages/GPÜ_Ingolstadt.jpg"
    },
    {
    ...
    },
    {
        ...
        image: "../QuizImages/Doppelweichungskreuzung.jpg"
    },
    {
    ...
    },
    {
        ...
        image: "../QuizImages/Ks-Mehrabschnittssignal.jpg"
    },
    {
    ...
    },
    {
        ...
        image: "../QuizImages/Ks_Ks2+Zusatzlicht_(oben).svg"
    },
    {
        question: "In welchen 5 Schritten erfolgt das Umstellen einer Weiche?",
        answers: [
            {
                text: "1. Weichenüberwachung abschalten 2. Drehsinn ändern 3. Stellstrom anschalten 4. Bei Erreichen der Endlage Stellstrom abschalten 5. Überwachung wieder einschalten",
                correct: true
            },
            {
                text: "1. Stellstrom anschalten 2. Weichenüberwachung abschalten 3. Drehsinn ändern 4. Überwachung wieder einschalten 5. Stellstrom abschalten",
                correct: false
            },
            {
                text: "1. Weiche abschalten 2. Weiche umkurbeln 3. Weiche in Endlage bringen 4. Weiche zuschalten 5. Fahrdienstleiter anrufen",
                correct: false
            },
            {
                text: "1. Fahrdienstleiter anrufen 2. Small-Talk führen 3. Weiche umstellen lassen 4. Weiche reversieren 5. Gespräch beenden",
                correct: false
            }
        ],
        image: "../QuizImages/Nahverkehrszüge_Frankfurt.jpg"
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: "Wenn technisch nicht ausgeschlossen ist, dass Züge auf dem BÜ zum Stehen kommen könnten",
                correct: false
            },
    ...
    },
    {
        ...
        image: "../QuizImages/Triebfahrzeugführer_IC-Steuerwagen.jpg"
    },
    {
    ...
    },
    {
        ...
        image: "../QuizImages/Elektronisches_Stellwerk_Köln-Betriebsbahnhof-3887.jpg"
    },
    {
        ...
        image: "../QuizImages/Einfahrt_der_Dreiseenbahn_in_den_Bahnhof_Titisee.jpg"
    },
    {
    ...
    },
    {
        ...
        answers: [
            {
                text: "Er darf mit 160 km/h (bzw. nach Fahrplangeschwindigkeit) am Signal vorbeifahren, muss aber am nächsten Signal auf 40 km/h heruntergebremst haben",
                correct: true
            },
            {
                text: "Er darf mit 160 km/h (bzw. nach Fahrplangeschwindigkeit) am Signal vorbeifahren, muss aber am nächsten Signal zum Stehen kommen",
                correct: false
            },
            {text: "Er muss zum Stehen kommen, darf aber in 4 Sekunden weiterfahren", correct: false},
            {
                text: "Er darf mit 40 km/h am Signal vorbeifahren, muss aber am nächsten Signal zum Stehen kommen",
                correct: false
            }
        ],
        image: "../QuizImages/Ks-Mehrabschnittssignal.jpg"
    ...
    },
    {
        ...
        image: "../QuizImages/Ks_Ks2+Zusatzlicht_(unten).svg"
    },
    {
        ...
        answers: [
            ...
            {
                text: "Ja, aber die Kontakte der Relais Ü+ und Ü- müssen dauerhaft mit einem Schrumpfschlauch isoliert werden",
                correct: false
            }
        ],
