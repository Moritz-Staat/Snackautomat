const questions = [
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: "Sowohl durch Umpolen der Versorgungsspannung, als auch durch Ein oder -Ausschalten eines Steuersignals",
                correct: false
            }
        ],
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: "Abschnitt der beim Einstellen der Fahrstraße und nach Fahrstellung des Signals auf Freisein überwacht wird",
                correct: false
            },
...
initQuiz({
    timerSeconds: AUTOMAT_CONFIG.frage_timer.level3,
    questions: questions,
    tiers: [
    {
