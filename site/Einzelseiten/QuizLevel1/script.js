const questions = [
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: "Der Fahrdienstleiter muss durch hinsehen das Freisein des Abschnitts überprüfen und die Freimelde-Taste drücken",
                correct: false
            },
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: "Mit dem Zug pfeifen, um sich vor unbeschrankten Bahnübergängen den Straßenverkehrsteilnehmern anzukündigen",
                correct: true
            },
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: "Damit sich das Metall der Weiche nicht zusammenzieht und es einen Schienenbruch gibt",
                correct: false
            },
            {
                text: "Damit die Personen, die an der Weiche arbeiten, sich im Winter die Hände wärmen können",
                correct: false
            }
        ],
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: "Bei Neu- oder Umbauten zu prüfen, ob die Anlage nach der freigegebenen Planung unter Einhaltung der Richtlinien gebaut wurde",
                correct: true
            },
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: "Der Straßenverkehr hat auf Bahnübergängen grundsätzlich Vorrang vor dem Eisenbahnverkehr",
                correct: false
            },
            {text: "Das Fahrzeug welches von links kommt hat Vorfahrt", correct: false},
            {
                text: "Der Eisenbahnverkehr hat auf Bahnübergängen grundsätzlich Vorrang vor dem Straßenverkehr",
                correct: true
            }
        ],
    ...
    },
    {
        ...
        answers: [
            {
                text: "Weil er die sogenannte \"4.2er-Ausbildung\" (4 Wochen Theorie, 2 Wochen Praxis) gemacht hat",
                correct: false
            },
            ...
            {
                text: "Weil es bei jeder Baumaßnahme mindesten 4 Technisch Berechtigte geben muss, wovon 2 anwesend sein müssen",
                correct: false
            }
        ],
        image: "../QuizImages/Baustelle_S-Bahn_Schönhauser_Allee,_Berlin_(7047921593).jpg"
    ...
    },
    {
        ...
        answers: [
            {
                text: "Ein Relais ist ein Schalter, der nicht von Hand, sondern mithilfe eines Elektromagneten aktiviert wird.",
                correct: true
            },
...
initQuiz({
    timerSeconds: AUTOMAT_CONFIG.frage_timer.level1,
    questions: questions,
    tiers: [
    {
